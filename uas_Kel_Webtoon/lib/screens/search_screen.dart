...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _searchWebtoons() async {
    ...
    final List<Map<String, dynamic>> searchData =
        await _apiService.searchWebtoons(_searchController.text);


    setState(() {
      _searchResults = searchData.map((e) => Webtoon.fromJson(e)).toList();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Search Webtoons')
        ),
      body: Padding(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Padding(
                    ...
                    child: ListTile(
                        ...
                        'https://image.tmdb.org/t/p/w200${webtoon.posterPath}',
                        height: 50,
                        width: 50,
                        fit: BoxFit.cover,
                      ),
